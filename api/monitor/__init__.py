def register_url(api_rest):
    ...
    from api.monitor.resources.metrics_list import MetricsList
    ...
    from api.monitor.resources.judge_item import JudgeItemList, AlertItemList

    api_rest.add_resource(MonitorData, '/monitor/v1/items')
    api_rest.add_resource(HostList, '/monitor/v1/hosts')
    api_rest.add_resource(MetricsList, '/monitor/v1/metrics')
    ...
    api_rest.add_resource(AlertItemList, '/monitor/v1/alert_items')
